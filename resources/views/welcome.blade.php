...
<body class="antialiased">
    <x-guest-layout>
        ...
        <section class="px-2 py-32 bg-gray-900 md:px-0">
        ...
        <section class="pt-4 pb-12 bg-gray-800">
            <div class="my-16 text-center">
                <h2
                    ...
                    Testimonial </h2>
                <p class="text-xl text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. soluta sapient
                </p>
            </div>
            <div class="grid gap-2 lg:grid-cols-3">
                <div class="max-w-md p-4 bg-gray-900 rounded-lg shadow-lg">
